...
<p class='email'>Email: <span>${user.email}</span></p> <p class='point'>Point: <span>${user.point}</span></p>
<p class='phone'>Phone: <span>${user.phone}</span></p><p class='company'>Company: <span>${user.company}</span></p>`;
console.log(html);
